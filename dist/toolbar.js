...
var Toolbar = function () {
    ...
    (0, _createClass3.default)(Toolbar, [{
        ...
        key: "setMode",
        value: function setMode(switchName) {
            var _this2 = this;

            // 拿到所有的button
            var buttons = this.frame.querySelectorAll('.button');
            // 匹配到模式并设置样式，设置当前的selected
            (0, _from2.default)(buttons).forEach(function (button) {
                var name = button.getAttribute('data-name');
                if (switchName === name) {
                    button.classList.add('selected');
                    _this2.selected = button;
                } else {
